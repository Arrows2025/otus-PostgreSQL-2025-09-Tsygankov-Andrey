...
:one: Актуальность данных — это степень, до которой данные обновлены и соответствуют текущему моменту времени, отражают реальное состояние целевого субъекта. В схеме витрины актуальность данных обеспечена триггером с автоматическим пересчётом сумм продаж взависимости от этих продаж - при любом изменении таблицы `sales` (вставка, обновление, удаление) данные в витрине изменятся автоматически
