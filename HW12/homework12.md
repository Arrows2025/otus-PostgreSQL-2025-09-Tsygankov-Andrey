...
:one: Актуальность данных. В схеме витрины актуальность данных обеспечена триггером с автоматическим пересчётом сумм продаж в зависимости от этих продаж - при любом изменении таблицы `sales` (вставка, обновление, удаление) данные в витрине изменятся автоматически

:two: Своевременность данных. В схеме витрины данные отображаются без задержек сразу же после факта продажи, в отличие от отчёта по требованию, на создание которого потребуется определённое время

:three: Точность данных. Точность данных витрины обеспечена триггером с автоматическим пересчётом сумм продаж в зависимости от текущей цены товара
