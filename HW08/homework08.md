...
2️⃣ Открываю три сессии коннекта к базе данных в разных окнах `sudo -u postgres psql --cluster 18/otus`, в каждой по очереди запускаю UPDATE одной и той же строки
...
После запуска каждого UPDATE в разных сессиях проверяю наличие блокировок в pg_locks
