...
Для выполнения домашнего задания разворачиваю демонстрационную базу данных для СУБД PostgreSQL, которая в качестве предметной области использует авиаперевозки, выбираю объём данных по полётам за год - https://edu.postgrespro.ru/demo-20250901-1y.sql.gz
