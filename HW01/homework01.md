...
Установление статического IP-адреса 192.168.0.50 через редактирование файла: `sudo nano /etc/netplan/01-netcfg.yaml` и применения новых сетевых настроек: `sudo netplan apply`  
